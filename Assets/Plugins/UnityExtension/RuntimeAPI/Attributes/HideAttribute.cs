    ...
    public sealed class HideAttribute : PropertyAttribute
    {
        ...
        class HideDrawer : BasePropertyDrawer<HideAttribute>
        {
            public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
            {
                ...
                {
                    var field = Utilities.GetFieldInfo(property.serializedObject.targetObject, attribute._name);
                    ...
                    {
                        var prop = Utilities.GetPropertyInfo(property.serializedObject.targetObject, attribute._name);
