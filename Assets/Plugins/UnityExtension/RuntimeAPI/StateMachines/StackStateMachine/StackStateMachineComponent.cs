...
namespace UnityExtension
{
    ...
    public class StackStateMachineComponent<T> : ScriptableComponent, IStackState where T : class, IStackState
    {
        ...
        /// <summary>
        /// 状态入栈后触发，参数 pushedState
        /// </summary>
        public event Action<T> statePushed;


        /// <summary>
        /// 状态出栈后触发，参数 poppedState
        /// </summary>
        ...
        public void PushState(T newState)
        {
            ...
            if (_duringSetting)
            {
                throw new Exception("Shouldn't change state inside OnExit, OnEnter or statePushed event!");
            }
            _duringSetting = true;
#endif
        ...
        public void PopState()
        {
            ...
            if (_duringSetting)
            {
                throw new Exception("Shouldn't change state inside OnExit, OnEnter or statePopped event!");
            }
            _duringSetting = true;
#endif
            ...
            statePopped?.Invoke(originalState);
