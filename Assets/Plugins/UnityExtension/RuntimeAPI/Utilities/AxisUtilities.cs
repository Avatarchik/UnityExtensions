...
namespace UnityExtension
{
    ...
    public partial struct Utilities
    {
        ...
        /// </summary>
        public static Vector3 AxisToVector(Axis localAxis, Transform transform)
        {
            switch (localAxis)
            {
        ...
        /// </summary>
        public static Axis AxisFromVector(Vector3 vector)
        {
        ...
        /// </summary>
        public static Axis ReverseAxis(Axis axis)
        {
            switch (axis)
            {
        ...
        /// a, b 必须为有向轴, 否则结果未定义
        /// </summary>
        public static AxisRelation AxisRelationBetween(Axis a, Axis b)
        {
            if (a == b)
            {
        ...
        /// axis 必须为有向轴, 否则结果未定义
        /// </summary>
        public static bool IsAxisPositive(Axis axis)
        {
            return (int)axis <= 4;
        }
